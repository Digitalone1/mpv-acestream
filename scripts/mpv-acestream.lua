    ...
    -- the choice.
    -- For example, with Firefox, you should be asked to open it with an app, but mpv 
    -- will not show inside the list. Then browse your filesystem and select the mpv
    -- executable installed on your distibution (it is usually placed at /usr/bin/mpv).
    -- If Firefox does not open it properly and will not prompt the opening popup, 
    -- go in Preferences, locate "Applications" section and modify acestream entry 
    -- by setting mpv as the default application.
    --
